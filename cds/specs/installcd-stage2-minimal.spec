...
livecd/fsscript: /var/tmp/catalyst/releases/weekly/scripts/installcd.sh
...
boot/kernel/gentoo/sources: gentoo-sources:4.14.57
boot/kernel/gentoo/config: /var/tmp/catalyst/releases/weekly/kconfig/amd64/installcd-kmscon-4.14.57.config
